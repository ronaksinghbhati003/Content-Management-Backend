...
import publishRouter, { publicPublishRouter } from '../modules/publish/publish.route';
import analyticsRouter from '../modules/analytics/analytics.route';
import editorRouter from '../modules/editor/editor.route';
...
router.use('/publish', publicPublishRouter);
