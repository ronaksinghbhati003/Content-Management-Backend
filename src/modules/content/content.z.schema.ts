...
const baseContentSchema = z.object({
    ...
    thumbnails: z.object({
        youtube:   z.preprocess(v => v ?? undefined, z.string().optional().or(z.literal(''))),
        instagram: z.preprocess(v => v ?? undefined, z.string().optional().or(z.literal(''))),
        shorts:    z.preprocess(v => v ?? undefined, z.string().optional().or(z.literal(''))),
    }).optional(),
